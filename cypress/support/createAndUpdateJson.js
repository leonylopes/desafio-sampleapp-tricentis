...
// Função para calcular a data atual + 60 dias no formato MM/DD/YYYY
function calcularDataMais60Dias() {
    const hoje = new Date();
    hoje.setDate(hoje.getDate() + 60); // Adiciona 60 dias à data atual
...
fs.readFile(filePath, 'utf-8', (err, data) => {
    ...
    try {
        ...
        const novaData = calcularDataMais60Dias();
